...
public class Enano
{
    ...
    {
        return $"El Enano lucha con una fuerza de {Fuerza}"; // Retorna un mensaje indicando la fuerza de lucha
    }
}

// Clase Item para representar los objetos que un enano puede usar
public class Item
{
    // Propiedades del item
    public string Nombre { get; set; } // Nombre del item
    public int Ataque { get; set; } // Valor de ataque del item
    public int Defensa { get; set; } // Valor de defensa del item
    ...
    // Método que retorna una cadena describiendo el item
    public override string ToString()
    {
        return $"{Nombre}: Ataque {Ataque}, Defensa {Defensa}"; // Retorna el nombre, ataque y defensa del item
    }
}
